...
public class RNIronSourceOfferwallModule extends ReactContextBaseJavaModule {
    ...
    private static final String kDidFailToReceiveOfferwallCreditsWithError = "didFailToReceiveOfferwallCreditsWithError";
    private static final String kDidReceiveOfferwallCredits = "didReceiveOfferwallCredits";
    private static final String kOfferwallDidClose = "offerwallDidClose";
    private static final String kOfferwallDidFailToShowWithError = "offerwallDidFailToShowWithError";
    private static final String kOfferwallDidShow = "offerwallDidShow";
    private static final String kOfferwallHasChangedAvailability = "offerwallHasChangedAvailability";
            ...
            public void run() {
                IronSource.setOfferwallListener(new OfferwallListener() {
                    ...
                    public void onOfferwallAvailable(boolean isAvailable) {
                        ...
                        payload.putBoolean("available",isAvailable);
                        sendEvent(kOfferwallHasChangedAvailability, payload);
                    }
                    /**
                    ...
                    public void onOfferwallOpened() {
                        ...
                        sendEvent(kOfferwallDidShow, null);
                    ...
                    public void onOfferwallShowFailed(IronSourceError error) {
                        ...
                        sendEvent(kOfferwallDidFailToShowWithError, null);
                    }
                    /**
                    ...
                    public boolean onOfferwallAdCredited(int credits, int totalCredits, boolean totalCreditsFlag) {
                        Log.d(TAG, "onOfferwallAdCredited() called!" + "credits: " + credits + "totalCredits: " + totalCredits + "totalCreditsFlag: " + totalCreditsFlag);
                        sendEvent(kOfferwallDidFailToShowWithError, null);
                        return false;
                    }
                    /**
                    ...
                    public void onGetOfferwallCreditsFailed(IronSourceError error) {
                        Log.d(TAG, "onGetOfferwallCreditsFailed() called!" + error);
                        sendEvent(kOfferwallDidFailToShowWithError, null);
                    }
                    /**
                    ...
                    public void onOfferwallClosed() {
                        ...
                        sendEvent(kOfferwallDidClose, null);
                    }
                });
            }
        });
